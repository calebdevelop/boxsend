...
<div id="tab-carrier-selection" {if !isset($smarty.get.carriers) || $smarty.get.carriers != 1}style="display: none"{/if}>
    <fieldset id="dhl-settings-introduction" style="margin-top: 10px">
        ...
        <br>
        <div>
            <label for="dpb_carrier_home">{l s='At home delivery' mod='dhlparcelbelux'}</label>
        ...
        <div>
            <label for="dpb_carrier_parcelshop">{l s='DHL Parcelshop delivery' mod='dhlparcelbelux'}</label>
            <div class="margin-form">
