...
<div id="tab-sender-details">
    <fieldset id="dhl-settings-introduction" style="margin-top: 10px">
        ...
        <div>
            <label for="dpb_details_firstname">
        ...
        <div>
            <label for="dpb_details_lastname">
        ...
        <div>
            <label for="dpb_details_house_number">
        ...
        <div>
            <label for="dpb_details_postal_code">
