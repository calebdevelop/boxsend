...
<div id="tab-product-options">
    <fieldset id="dhl-settings-product-selection" style="margin-top: 10px">
        ...
        <div>
            <label for="dpb_parcelshop_delivery">
    ...
    <fieldset id="dhl-settings-product-options-benelux" style="margin-top: 10px">
        ...
        <div>
            ...
            <div class="margin-form">
                ...
                {/if}
                <input style="margin: 5px 5px 5px 0" type="checkbox" name="dpb_belux_saturdays" id="dpb_belux_saturdays" value="1" {if isset($settings.belux_saturdays) && $settings.belux_saturdays == 1}checked="checked"{/if}> {l s='Saturday delivery' mod='dhlparcelbelux'}
                <br>
