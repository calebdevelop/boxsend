...
<div class="addresses clearfix">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6"{if $cart->isVirtualCart()} style="display:none;"{/if} style="display: none;">
			<ul class="address item box" id="address_delivery" style="display:none;">
			</ul>
		</div>
